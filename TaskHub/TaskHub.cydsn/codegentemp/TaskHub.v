// ======================================================================
// TaskHub.v generated from TopDesign.cysch
// 05/12/2025 at 20:56
...
module top ;
	...
	wire [0:0] tmpOE__TASK_LED_net;
	wire [0:0] tmpFB_0__TASK_LED_net;
	wire [0:0] tmpIO_0__TASK_LED_net;
	wire [0:0] tmpINTERRUPT_0__TASK_LED_net;
	electrical [0:0] tmpSIOVREF__TASK_LED_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("d9336884-bac0-42bb-88a7-50bbc10ca72c"),
		  ...
		  .input_buffer_sel(2'b00))
		TASK_LED
		 (.oe(tmpOE__TASK_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TASK_LED_net[0:0]}),
		  .io({tmpIO_0__TASK_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__TASK_LED_net),
		  .interrupt({tmpINTERRUPT_0__TASK_LED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TASK_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
