...
void SwInt_SetVector(cyisraddress address)
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + (uint32)SwInt__INTC_NUMBER] = address;
}
...
cyisraddress SwInt_GetVector(void)
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + (uint32)SwInt__INTC_NUMBER];
}
